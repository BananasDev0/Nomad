...
export default function PlacesScreen() {
  const [places, setPlaces] = useState([
    ...
    { id: 4, name: "Barrio Antiguo", discarded: false },
    { id: 5, name: "Paseo Santa Lucía", discarded: false },
    { id: 6, name: "Planetario Alfa", discarded: false },
    { id: 7, name: "Bioparque Estrella", discarded: false },
    { id: 8, name: "Macroplaza", discarded: false },
  ]);
  ...
  return (
    <SafeAreaView className="flex-1 bg-white p-5">
        {/* Título */}
        <View className="p-10">
          <Title title="Selecciona tus lugares" hasBackButton={false} />
        </View>
